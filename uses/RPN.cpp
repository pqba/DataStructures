...
/*Running : 'g++ -I../ -o RPN RPN.cpp ../Stack.cpp ../Data.cpp' then as usual, './RPN'
  In this command, -I../ adds the parent directory to the include path, so RPN.cpp can correctly find Stack.h and Data.h.
*/
#include <iostream>
#include <stdexcept>
#include "../Stack.h"
...
public:
    ...
    {
        parseEq(s);
        std::cout << "RPN constructor print. " << std::endl;
        notator.stack_print();
    }
    ~RPN()
    {
